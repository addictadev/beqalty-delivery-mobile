...
class ChangesPasswordSucessfullyScreen extends StatefulWidget {
  const ChangesPasswordSucessfullyScreen({super.key});

  @override
  State<ChangesPasswordSucessfullyScreen> createState() =>
      _ChangesPasswordSucessfullyScreenState();
}

class _ChangesPasswordSucessfullyScreenState
    extends State<ChangesPasswordSucessfullyScreen> {
  @override
  ...
  Widget _buildIcon() {
    return CustomSvgImage(assetName: AppAssets.successImg);
  }
